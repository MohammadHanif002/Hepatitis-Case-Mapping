            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="/posts" :active="request()->is('posts')">Statistik Kasus</x-nav-link>
                        <x-nav-link href="/about" :active="request()->is('about')">Peta Sebaran</x-nav-link>
                        <x-nav-link href="/contact" :active="request()->is('contact')">Data Kasus</x-nav-link>
                        {{-- <a href="/blog"
